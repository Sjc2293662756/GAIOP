...
function buildNapmRoutingSystemContext() {
  ...
  return [
    ...
    'For today/yesterday, compute Shanghai local-day windows from the runtime date: today starts at 00:00:00 and ends at the current server minute; yesterday ends at 23:59:00. Never hard-code example timestamps from previous turns.',
    ...
    'Bad resolvedQuery example: `{service:"topValues", timeRange:{start:1779638400,end:1779724799}}`. Good example: `{service:"topValues", timeRange:{key:"today"}}`; the plugin resolves root `start`/`end` from the current server clock.',
